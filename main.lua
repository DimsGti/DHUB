...
local GAME_SCRIPTS = {
    [93978595733734] = "loadstring(game:HttpGet("https://raw.githubusercontent.com/DimsGti/ViolenceDistrict/main/main.lua"))()",
    [125927821145949] = "loadstring(game:HttpGet("https://raw.githubusercontent.com/DimsGti/MAMv2/refs/heads/main/main.lua"))()",
}
...
local function dispatch()
    ...
    if url then
        ...
        LocalPlayer:Kick("D-Hub — Not Supported In This Game.")
    end
end
